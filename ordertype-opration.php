...
//if(!$zaban==null&&!$zamineh==null&&!$topic==null&&!$dates==null){
    ...
    $sql="INSERT INTO ordertype (zaban,zamineh,topic,erja,formula,safhe,tasvir,tables,chart,shape,tozihat,dates,payk,files,peigiri,email,currentdate,state) value ('$zaban','$zamineh','$topic','$erja','$formula','$safhe','$tasvir','$tables','$chart','$shape','$tozihat','$dates','$payk','$files','$peigiri','$email','$currentdate','$state')";
                    ...
                    <fieldset>
						...
						<div class='form-group'>
							...
							<div class='col-md-4 inputGroupContainer'>
								<div class='input-group'> 
									<input name='topic' class='form-control' type='text' value='11'>
								</div>
							</div>
                        </div>
						<!-- Text input-->
                        ...
                        <!--chekbox-->
                                    ...
                                    <lable>فرمول نویسی</lable>
                                        ...
                                        <input type='textarea' class='txt-area' name='tozihat' value='10' ><br>
