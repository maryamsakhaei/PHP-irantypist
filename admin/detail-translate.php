    ...
    <div class='row'><!--row-main-box-->
        ...
        <div class='col-md-8 left-side'>
            ...
            ?> 
                ...
                <tr>
                    <td class="right-col"> زبان  ترجمه</td>
                    <td>
                         <?php 
                            $zaban=$row["zaban"];
                            if($zaban==0){
                ...
                <tr>
                    ...
                    <td>
                    <form action="state-translate-opration.php" method="GET">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form action="motoon-translate-opration.php" method="GET">
                    <P> تعداد کلمات شما</P>
                     <input type="number" name="wordcount" value="">
                        <input type="hidden" name="peigiri" value="<?php echo $peigiri ?>" >
                            <select name="matn">
                                <option value="0">متون تخصصی </option>  
                                <option value="1">متون تخصصی ویژه</option>
