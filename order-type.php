            ...
            <div class='col-md-8 main-box'><!--row-into box--> 
                 <div class='row'> 
                    ...
                    <div class='col-md-9 left-side'>
                        <div class='order'>
                            <p class='order-new'> ثبت سفارش تایپ</p>
                        </div><!--order--->
				...
				<form class='well form-horizontal' action='ordertype-opration.php ' method='POST' id='contact_form'>
                    <fieldset>
						...
						<div class='form-group'>
							...
							<div class='col-md-4 selectContainer'>
                                ...
                                <option type='combobox' value='0'>فارسی  </option>
                                <option type='combobox' value='1'> انگلیسی</option>
                                <option type='combobox' value='2'> آلمانی</option>
                                <option type='combobox' value='3'> روسی</option>
                                <option type='combobox' value='4'>اسپانیایی </option>
                                <option type='combobox' value='5'> کردی </option>
                                <option type='combobox' value='6'>ترکی استانبولی </option>
                                <option type='combobox' value='7'>عربی</option>
                                </select>
								</div>
							</div>
						</div>
